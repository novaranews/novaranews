<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">{{ __('site.admin_edit_category') }}</h2>
    </x-slot>

    <div class="admin-page-wrap">
        <div class="admin-shell max-w-6xl">
            <p class="mb-4 text-sm text-gray-600">{{ __('site.admin_internal_key') }}: <span class="font-mono font-semibold text-gray-900">{{ $category->key }}</span></p>
            <form method="post" action="{{ route('admin.categories.update', $category) }}" class="admin-form-card">
                ...
                @foreach($locales as $loc)
                    @php $tr = $translations->get($loc); @endphp
                    <fieldset class="rounded-lg border border-gray-200 p-4" data-category-locale-panel="{{ $loc }}">
                        ...
                        <div class="mt-3 space-y-3">
                            <div>
                                ...
                                <x-text-input :id="'name_'.$loc" class="mt-1 block w-full" type="text" :name="'translations['.$loc.'][name]'" :value="old('translations.'.$loc.'.name', $tr?->name)" required />
                            ...
                            <div>
                                ...
                                <x-text-input :id="'slug_'.$loc" class="mt-1 block w-full font-mono text-sm" type="text" :name="'translations['.$loc.'][slug]'" :value="old('translations.'.$loc.'.slug', $tr?->slug)" required />
                            ...
                            <div>
                                ...
                                <x-text-input :id="'intro_'.$loc" class="mt-1 block w-full" type="text" :name="'translations['.$loc.'][intro]'" :value="old('translations.'.$loc.'.intro', $tr?->intro)" maxlength="500" />
                            ...
                            <div>
                                ...
                                <x-text-input :id="'meta_title_'.$loc" class="mt-1 block w-full" type="text" :name="'translations['.$loc.'][meta_title]'" :value="old('translations.'.$loc.'.meta_title', $tr?->meta_title)" maxlength="255" />
                            ...
                            <div>
                                ...
                                <x-text-input :id="'meta_description_'.$loc" class="mt-1 block w-full" type="text" :name="'translations['.$loc.'][meta_description]'" :value="old('translations.'.$loc.'.meta_description', $tr?->meta_description)" maxlength="500" />
                            ...
                            <div>
                                ...
                                <x-text-input :id="'og_title_'.$loc" class="mt-1 block w-full" type="text" :name="'translations['.$loc.'][og_title]'" :value="old('translations.'.$loc.'.og_title', $tr?->og_title)" maxlength="255" />
                            ...
                            <div>
                                ...
                                <x-text-input :id="'og_description_'.$loc" class="mt-1 block w-full" type="text" :name="'translations['.$loc.'][og_description]'" :value="old('translations.'.$loc.'.og_description', $tr?->og_description)" maxlength="500" />
                            ...
                            <div>
                                ...
                                <x-text-input :id="'canonical_url_'.$loc" class="mt-1 block w-full" type="url" :name="'translations['.$loc.'][canonical_url]'" :value="old('translations.'.$loc.'.canonical_url', $tr?->canonical_url)" maxlength="500" :placeholder="__('site.admin_placeholder_canonical_url')" />
                            ...
                            <div>
                                ...
                                <x-text-input :id="'og_image_url_'.$loc" class="mt-1 block w-full" type="url" :name="'translations['.$loc.'][og_image_url]'" :value="old('translations.'.$loc.'.og_image_url', $tr?->og_image_url)" maxlength="500" :placeholder="__('site.admin_placeholder_og_image_url')" />
